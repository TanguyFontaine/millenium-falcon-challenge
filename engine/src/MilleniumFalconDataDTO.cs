...
public class MilleniumFalconDataDto : IEquatable<MilleniumFalconDataDto>
{
    ...
    public bool Equals(MilleniumFalconDataDto? other)
    {
        if (other == null)
            return false;
    ...
    {
        return Equals(obj as MilleniumFalconDataDto);
    }
...
public class MilleniumFalconParser
{
    public static MilleniumFalconDataDto Parse(string jsonContent)
    {
        try
        {
            MilleniumFalconDataDto? milleniumFalconDto = JsonSerializer.Deserialize<MilleniumFalconDataDto>(jsonContent, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });

            if (milleniumFalconDto == null)
            {
                throw new InvalidDataException("Failed to read millenium falcon data - invalid JSON structure");
            }

            return milleniumFalconDto;
        }
